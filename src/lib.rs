...
#[derive(Debug)]
pub struct VercelMeshProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VercelMeshProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VercelMesh processing");
    
    let mut processor = VercelMeshProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VercelMeshProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VercelMeshProcessor::new(false);
